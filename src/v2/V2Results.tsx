import {AlertTriangle,Clock3,Layers3,RefreshCw} from 'lucide-react';
...
export default function V2Results({dashboard}:{dashboard:V2Dashboard}){
  ...
  const cards=[['Total',number(totals.movements),Layers3,'total'],['Reconciliados',number(totals.reconciled),RefreshCw,'good'],['Em aberto',number(totals.open),Clock3,'warn'],['Com anomalias no saldo',number(totals.balance_anomalies),AlertTriangle,'bad']] as const;
